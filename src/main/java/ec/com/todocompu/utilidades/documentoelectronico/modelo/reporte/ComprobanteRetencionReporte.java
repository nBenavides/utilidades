...
import ec.com.todocompu.utilidades.documentoelectronico.modelo.rentencion.ImpuestoRetencion;
...
public class ComprobanteRetencionReporte {
	...
	public List<DetallesAdicionalesReporte> getDetallesAdiciones() {
		...
		for (ImpuestoRetencion im : this.comprobanteRetencion.getImpuestos()
				.getImpuesto()) {
	...
	public List<InformacionAdicional> getInfoAdicional() {
		if (this.comprobanteRetencion.getInfoAdicional() != null) {
			...
			if ((this.comprobanteRetencion.getInfoAdicional()
					.getCampoAdicional() != null)
					&& (!this.comprobanteRetencion.getInfoAdicional()
							.getCampoAdicional().isEmpty())) {
				for (ComprobanteRetencion.InfoAdicional.CampoAdicional ca : this.comprobanteRetencion
						.getInfoAdicional().getCampoAdicional()) {
					this.infoAdicional.add(new InformacionAdicional(ca
							.getValue(), ca.getNombre()));
				}
			}
		}
